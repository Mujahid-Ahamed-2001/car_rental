...
const CarCard = ({car}) => {
  ...
  return (
    <div className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer' onClick={()=>{
        navigate(`/car-details/${car._id}`); window.scrollTo(0,0);
    }}>
      <div className='relative h-48 overflow-hidden'>
        ...
        {car.isAvailable && <p className='absolute top-4 left-4 bg-primary/90 text-primary text-xs px-2.5 py-1 rounded-full'>Available Now</p>}
